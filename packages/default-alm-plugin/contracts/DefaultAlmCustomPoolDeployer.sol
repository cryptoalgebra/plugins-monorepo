...
import './interfaces/IDefaultAlmCustomPoolDeployer.sol';
import './DefaultAlmPlugin.sol';

/// @title Algebra Integral 1.2.1 ALM custom plugin deployer
contract DefaultAlmCustomPoolDeployer is IDefaultAlmCustomPoolDeployer {
  /// @inheritdoc IDefaultAlmCustomPoolDeployer
