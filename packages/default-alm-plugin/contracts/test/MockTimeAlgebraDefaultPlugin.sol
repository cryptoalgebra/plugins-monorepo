...
contract MockTimeAlgebraDefaultPlugin is DefaultAlmPlugin {
  ...
  constructor(
    ...
    bytes32 _configId
  ) DefaultAlmPlugin(_pool, _factory, _pluginFactory, _config, _securityRegistry, _reflexRouter, _configId) {}
