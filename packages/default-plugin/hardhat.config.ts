...
const config: HardhatUserConfig = {
  ...
  dependencyCompiler: {
    paths: [
      ...
      '@cryptoalgebra/kyc-plugin/contracts/KycPluginImplementation.sol',
      '@cryptoalgebra/kyc-plugin/contracts/test/MockIdFactory.sol',
      '@cryptoalgebra/kyc-plugin/contracts/test/MockIdentity.sol',
      '@cryptoalgebra/kyc-plugin/contracts/test/MockClaimIssuer.sol',
    ],
  },
