...
contract UpgradeableKycPluginTest is UpgradeableAbstractPlugin, KycConnector {
  ...
  /// @param _kycRegistry The KYC registry address
  function initialize(address _pool, address _kycRegistry) external initializer onlyPluginFactory {
    _initializeKyc(_kycRegistry);
  }
